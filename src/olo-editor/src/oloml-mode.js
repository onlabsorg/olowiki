...
//module.exports = require("brace/mode/ejs");
...
ace.define("ace/mode/oloml",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules","ace/mode/javascript_highlight_rules","ace/lib/oop","ace/mode/html","ace/mode/javascript","ace/mode/css","ace/mode/ruby"], function(acequire, exports, module) {
    "use strict";
    ...
    var EjsHighlightRules = function(start, end) {
        ...
        this.embedRules(new JavaScriptHighlightRules({jsx: false}).getRules(), "oloml-", [{
            token : "markup.list.meta.tag",
            regex : "-?" + end,
            next  : "pop"
        }, {

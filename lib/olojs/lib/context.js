...
const NOTHING = exports.NOTHING = null;
const FALSE   = exports.FALSE   = 0;
const TRUE    = exports.TRUE    = 1;
const LT = exports.LT = -1;
const EQ = exports.EQ = 0;
const GT = exports.GT = +1;
const INFINITY = exports.INFINITY = Infinity;
const ETC = exports.ETC = parser.ETC;
...
exports.$dot = function (namespace, name) {
...
exports.$call = async function (callable, ...args) {
...
exports.$query = async function (container, key) {
...
exports.$getPrototypeOf = function (X) {
...
exports.$add = async function (L, R) {
...
exports.$sub = async function (L, R) {
...
exports.$mul = async function (L, R) {
...
exports.$div = async function (L, R) {
...
exports.$mod = async function (L, R) {
...
exports.$pow = async function (L, R) {
...
exports.$eq = async function (L, R) {
    const cmp = await compare(this, L, R);
    return cmp === EQ ? TRUE : FALSE;
}

exports.$ne = async function (L, R) {
    const cmp = await compare(this, L, R);
    return cmp === EQ ? FALSE : TRUE;
}

exports.$lt = async function (L, R) {
    const cmp = await compare(this, L, R);
    return cmp === LT ? TRUE : FALSE;
}

exports.$le = async function (L, R) {
    const cmp = await compare(this, L, R);
    return cmp === GT ? FALSE : TRUE;
}

exports.$gt = async function (L, R) {
    const cmp = await compare(this, L, R);
    return cmp === GT ? TRUE : FALSE;
}

exports.$ge = async function (L, R) {
    const cmp = await compare(this, L, R);
    return cmp === LT ? FALSE : TRUE;
}

exports.$and = async function (L, R) {
    return await this.bool(L) && await this.bool(R);
}

exports.$or = async function (L, R) {
    return await this.bool(L) || await this.bool(R);
}

exports.$if = async function (L, R) {
    const BR = await this.bool(R);
    return BR === TRUE ? L : NOTHING;
}

exports.$else = async function (L, R) {
...
exports.__render__ = async function (text) {
    return text;
}

exports.eval = async function (expr) {
    const tokens = lexer.tokenize(expr);
    const ast = parser.parse(tokens);
    return await ast.evaluate(this);
}

exports.size = async function (value) {
...
exports.bool = async function (value) {
    const size = await this.size(value);
    return size === 0 ? FALSE : TRUE;
}

exports.not = async function (value) {
    return await this.bool(value) === FALSE ? TRUE : FALSE;
}

exports.str = async function (X) {

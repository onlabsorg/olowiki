        ...
        "editMode": function (newMode, oldMode) {
            ...
            if (newMode === "template") {
                switch (this.doc.type) {
                    case "markdown": this.editorContent.type = "markdown"; break;
                    case "mustache": this.editorContent.type = "mustache"; break;
                    default:         this.editorContent.type = "html"; break;
                }            
                this.editorContent.value = this.doc.template;
            }
            else if (newMode === "settings") {
                this.editorContent.type = "yaml";

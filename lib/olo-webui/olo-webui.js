    ...
    const oloWebUIComponent = {
        ...
        methods: {
            ...
            async load () {
                ...
                try {
                    doc = await store.readDocument(this.docPath, user);
                } 
                catch (error) {
                    if (error instanceof errors.DocumentNotFoundError) {
                        doc = store.createEmptyDocument(this.docPath, user);
            ...
            async render () {
                ...
                this.docHTML = await doc.render( this.docSubPath || "render" );
            },
            ...
            save () {
                ...
                store.writeDocument(this.docPath, doc, user)
                .then(() => {

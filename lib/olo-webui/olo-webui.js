    ...
    const oloWebUIComponent = {
        ...
        computed: {
            ...
            readOnly: function () {
                ...
                return data.author && data.author !== "undefined" && data.author !== this.user.id;
            },            
        },
        ...
        watch: {
            ...
            "editMode": function (newMode, oldMode) {            
                if (this.editMode) {
                    this.docData.source = doc.source;
                }
                else {
                    this.applyChanges();
                    this.render();
        ...
        methods: {
            ...
            applyChanges () {
                doc.source = this.docData.source;
            },
